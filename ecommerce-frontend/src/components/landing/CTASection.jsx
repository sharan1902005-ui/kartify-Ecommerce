...
export default function CTASection() {
  ...
  return (
    <section className="py-28 relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute bottom-[-20%] left-[-10%] w-[400px] h-[400px] rounded-full opacity-[0.06] pointer-events-none"
        style={{ background: "radial-gradient(circle, white 0%, transparent 70%)" }}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <motion.p
          ...
          className="text-lg text-white/75 mb-10 max-w-lg mx-auto leading-relaxed"
        >
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.06, boxShadow: "0 20px 48px rgba(0,0,0,0.25)" }}
          whileTap={{ scale: 0.97 }}
          onClick={() => navigate("/products")}
          className="inline-flex items-center gap-3 px-10 py-5 rounded-2xl bg-white font-bold text-lg transition-all"
          style={{ color: "#0F766E", boxShadow: "0 12px 40px rgba(0,0,0,0.18)" }}
        >
